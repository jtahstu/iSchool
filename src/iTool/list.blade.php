...
<html>
	...
	<head>
		...
		<style type="text/css">
			.center,table tr th,#paginate,#paginate2,#compile-list-title{text-align:center}
			#compile-list-title{color:#1a5cc8}
			#main{margin-top:85px;padding-left:20px;padding-left:20px}
